                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtDescription" runat="server" 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtContent" runat="server" Content='<%# Bind("Content") %>' 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtDescriptionEn" runat="server" 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtContentEn" runat="server" 

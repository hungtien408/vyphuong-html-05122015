        ...
        <asp:RadGrid ID="RadGrid1" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="ID" DataField="AdsBannerID" SortExpression="AdsBannerID">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Từ ngày" DataField="FromDate" SortExpression="FromDate">
                        <ItemTemplate>
                            <%# string.Format("{0:dd/MM/yyyy}", Eval("FromDate"))%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" HeaderText="Đến ngày" DataField="ToDate" SortExpression="ToDate">
                        <ItemTemplate>
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtDescription" runat="server" Language="vi-VN" Skin="Office2007"

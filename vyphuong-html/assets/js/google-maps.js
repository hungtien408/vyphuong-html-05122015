...
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h2 style="color: #ec1d25;">DARLING CO.LTD</h2>' +
            '<div class="wrap-mapbox">' +
                '<p>Địa chỉ : 37A Lương Hữu Khánh, Q. 1, TP. Hồ Chí Minh</p>' +
                '<p>Tel: (08) 39256016 - 39255419 - Email: <a class="link-mail" href="mailto:tmlh@gmail.com">tmlh@gmail.com</a></p>' +
            '</div>' +
        '</div>';

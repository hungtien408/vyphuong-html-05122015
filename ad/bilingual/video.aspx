        ...
        <asp:RadGrid ID="RadGrid1" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="ID" DataField="VideoID" SortExpression="VideoID">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn  Visible="false" HeaderText="Tiêu đề video(Tiếng Anh)" DataField="TitleEn"
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Mô tả" DataField="Description" SortExpression="Description">
                        <ItemTemplate>
                            <%# Eval("Description")%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" HeaderText="Danh mục" DataField="VideoCategoryName" SortExpression="VideoCategoryName">
                        <ItemTemplate>
                            <%# Eval("VideoCategoryName")%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" HeaderText="Ngày tạo" DataField="CreateDate" SortExpression="CreateDate">
                        <ItemTemplate>
                            <%# string.Format("{0:dd/MM/yyyy HH:mm}", Eval("CreateDate"))%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" HeaderText="Thứ tự" DataField="Priority" SortExpression="Priority">
                        <ItemTemplate>

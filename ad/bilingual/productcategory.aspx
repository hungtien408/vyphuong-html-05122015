        ...
        <asp:RadGrid ID="RadGrid1" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="ProductCategoryNameEn" HeaderText="Tên danh mục(Tiếng Anh)">
                        <ItemTemplate>
                            <div class='<%#"catlevel level" +  Eval("Level") %>' style='padding-left: <%# string.IsNullOrEmpty(Eval("Level").ToString()) ? 0 : Convert.ToInt32(Eval("Level")) * 10 %>px'>
                    ...
                    <asp:GridBoundColumn Visible="false" DataField="ProductCategoryID" HeaderText="ID" SortExpression="ProductCategoryID">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn>
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="ParentCategoryName" HeaderText="Danh mục cấp trên">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="IsShowOnMenu" HeaderText="Xem trên menu">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Ảnh">
                        <ItemTemplate>

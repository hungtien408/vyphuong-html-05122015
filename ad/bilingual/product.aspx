...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            ShowStatusBar="True" OnItemCommand="RadGrid1_ItemCommand" PageSize="50" OnItemDataBound="RadGrid1_ItemDataBound"
            OnPreRender="RadGrid1_PreRender" CssClass="grid" AllowAutomaticUpdates="True"
            CellSpacing="0">
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="ID" DataField="ProductID" SortExpression="ProductID">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="ProductName" HeaderText="Tên sản phẩm" SortExpression="ProductName" />
                    <asp:GridTemplateColumn Visible="false" DataField="SavePrice" HeaderText="Giá cũ" SortExpression="SavePrice">
                        <ItemTemplate>
                            <%# string.Format("{0:##,###.##}", Eval("SavePrice")) %>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" DataField="Price" HeaderText="Giá mới" SortExpression="Price">
                        <ItemTemplate>
                    ...
                    <asp:GridBoundColumn Visible="false" DataField="ManufacturerName" HeaderText="Nhà sản xuất" SortExpression="ManufacturerName" />
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="IsNew" HeaderStyle-Width="1%" HeaderText="Mới"
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="IsHot" HeaderText="Hot" SortExpression="IsHot">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsHot" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" DataField="IsBestSeller" HeaderText="Bán chạy" SortExpression="IsBestSeller">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" DataField="IsSaleOff" HeaderText="Giảm giá" SortExpression="IsSaleOff">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsSaleOff" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsSaleOff").ToString()) ? false : Eval("IsSaleOff") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" DataField="InStock" HeaderText="Còn hàng" SortExpression="InStock">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Đánh giá" SortExpression="Rating" HeaderStyle-Width="1%">
                        <ItemTemplate>
                            <isp:ContentRating ID="ContentRating1" runat="server" Enabled="false" CssClass="rating"
                                LegendText="{0} rates"></isp:ContentRating>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" HeaderStyle-Width="1%">
                        <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="ManufacturerSelectOne"

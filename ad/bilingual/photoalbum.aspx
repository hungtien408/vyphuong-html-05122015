        ...
        <asp:RadGrid ID="RadGrid1" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="ID" DataField="PhotoAlbumCategoryID" SortExpression="PhotoAlbumCategoryID">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Tên Album(Tiếng Anh)" DataField="PhotoAlbumCategoryNameEn"
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Xem trên menu" DataField="IsShowOnMenu" SortExpression="IsShowOnMenu">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Xem trên trang chủ" DataField="IsShowOnHomePage">
                        <ItemTemplate>

        ...
        <asp:RadGrid ID="RadGrid1" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="ID" DataField="PartnerID" SortExpression="PartnerID">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn Visible="false" HeaderText="Tên đối tác(Tiếng Anh)" DataField="PartnerNameEn"
                        SortExpression="PartnerNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblPartnerNameEn" runat="server" Text='<%# Eval("PartnerNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn Visible="false" HeaderText="Địa chỉ" DataField="Address" SortExpression="Address">
                        <ItemTemplate>
